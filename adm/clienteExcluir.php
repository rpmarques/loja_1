...
if ($_POST) {
    Logger('arquivo:[' . $wArquivo . ' ] - vamos tentar excluir CLIENTE');
    $retorno = $objCliente->delete($_POST['id'], EMPRESA_ID);
    if ($retorno) {
        Logger('arquivo:[' . $wArquivo . ' ] - ok - vamos tentar excluir CLIENTE id[' . $wClienteID . ']');
        $msg = "<div class=\"alert alert-success\">
               <button type=\"button\" class=\"close\" data-dismiss=\"alert\"><i class=\"ace-icon fa fa-times\"></i></button>
               <strong><i class=\"ace-icon fa fa-check\"></i>Operação realizada com sucesso!</strong>
               <br>Registro excluido.<br />
            </div>";
    } else {
        Logger('arquivo:[' . $wArquivo . ' ] - erro - vamos tentar excluir CLIENTE id[' . $wClienteID . ']');
            ...
            <div class="box">
                <form role="form" method="post">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Exclusão de Cliente</h3>
                    </div>
                    <div class="box-body">
                        <div class="col-md-12">
